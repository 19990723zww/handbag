...
export const zh: typeof vi = {
  ...
  meta: {
    ...
    defaultDesc:
      "越南胡志明市无纺布袋生产工厂：定制印刷 LOGO，100 个起批，免费设计打样图，全国发货。通过 Zalo 或 WhatsApp 联系，30 分钟内回复报价。",
    keywords: [
      "无纺布袋 越南",
      "定制印LOGO袋",
      "批发环保袋 胡志明市",
    ...
    ogLocale: "zh_CN",
    home: {
      title: "无纺布袋定制印刷 LOGO — 胡志明市工厂直供价",
      desc: "越南无纺布袋工厂：超市购物袋、奶茶外卖袋、广告宣传袋。100 个起批，免费设计，越南全国发货。",
    },
    products: {
    ...
    about: {
      ...
      desc: "位于胡志明市平新郡的无纺布袋工厂，2015 年至今：4 条缝制生产线、自有丝印车间、月产能 50,000 个。真正的出厂价。",
    },
    contact: {
      title: "联系报价 — 30 分钟内回复",
      desc: "通过 Zalo、WhatsApp、电话或报价表单联系工厂，工作时间 30 分钟内回复。工厂位于胡志明市平新郡。",
    },
  },
  ...
  footer: {
    blurb: "胡志明市无纺布袋定制印刷工厂。出厂价直供——没有中间商，越南全国发货。",
    linksTitle: "快速链接",
    linkProducts: "产品与价目表",
    linkProcess: "下单流程",
    linkAbout: "关于工厂",
  ...
  home: {
    ...
    benefits: [
      {
        title: "出厂价，无中间商",
        desc: "胡志明市工厂直接生产——价格按数量公开透明，订得越多单价越低。",
      },
      {
        title: "免费设计",
      ...
      {
        title: "全国发货",
        desc: "胡志明市内 1–2 天送达，其他省份 3–5 天由可靠物流配送。先验货后签收。",
      },
    ],
  ...
  processPage: {
    ...
    steps: [
      ...
      },
      {
        title: "生产与发货",
        time: "5–7 天",
        desc: "裁布、丝印/热转印、缝制成品并逐批质检。胡志明市内送货上门（1–2 天），外省经可靠物流发货（3–5 天）。收货时支付尾款。",
  ...
  aboutPage: {
    ...
    sub: "自 {year} 年起，{name}在胡志明市平新郡直接生产无纺布袋。您直接与一线生产者对接：真正的出厂价，修改响应快，对每一个袋子负责到底。",
    stats: [
      ["10+", "年无纺布袋生产经验"],
      ["50,000", "个 / 月最大产能"],
      ["1,200+", "家店铺客户"],
    ...
    capabilities: [
      {
        title: "自有缝制车间",
        desc: "4 条工业缝制生产线、25 名熟练工人，位于胡志明市平新郡。进度自主可控，不依赖外协加工——交期说到做到。",
      },
      {
        title: "厂内印刷",
    ...
    visit1: "胡志明市的客户欢迎到厂参观生产线、现场领取布料样品：",
    visit2: "（{hours}）。",
